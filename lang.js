...
(function(window) {
  ...
  var DICTIONARY = {
    ...
    bn: {
      ...
      explorePrivatian: 'দ্য প্রাইভেটিয়ান ফ্যামিলি এক্সপ্লোর করুন',
      readLatest: 'সাম্প্রতিক প্রতিবেদনসমূহ',
      events: 'ইভেন্ট ও আয়োজন',
      upcomingEvents: 'আসন্ন ইভেন্ট ও আয়োজন',
      ...
      readMore: 'আরও পড়ুন',
      newsletterTitle: 'দ্য প্রাইভেটিয়ান গেজেট সাবস্ক্রাইব করুন',
  ...
  var STATIC_TEXT_MAP_BN = {
    ...
    "EXPERIENCE": "অভিজ্ঞতা",
    "THE PRIVATIAN READS": "প্রাইভেটিয়ান পাঠ",
    "EVENTS": "ইভেন্ট ও আয়োজন",
    ...
    "Explore the Privatian": "দ্য প্রাইভেটিয়ান ফ্যামিলি এক্সপ্লোর করুন",
    ...
    "The Official Publication of The Privatian Society — Cambridge, Massachusetts": "দ্য প্রাইভেটিয়ান সোসাইটির অফিশিয়াল প্রকাশনা — ক্যামব্রিজ, ম্যাসাচুসেটস",
    "© 2026 The Privatian Family. All rights reserved.": "© ২০২৬ দ্য প্রাইভেটিয়ান ফ্যামিলি। সর্বস্বত্ব সংরক্ষিত।",
    "A series of profound questions explored by The Privatian Family experts.": "প্রাইভেটিয়ান বিশেষজ্ঞদের আলোচিত গভীর ও তাৎপর্যপূর্ণ চিন্তাধারার এক অনন্য সিরিজ।",
    ...
    "No upcoming events currently scheduled.": "বর্তমানে কোনো নির্ধারিত ইভেন্ট নেই।",
